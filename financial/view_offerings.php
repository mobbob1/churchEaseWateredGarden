...
if (isset($_POST['delete_id'])) {
    try {
        ...
        $_SESSION['message'] = "<div class='alert alert-success'>Offering record deleted successfully!</div>";
...
<head>
    ...
    <title>View Offerings - ChurchEaseSuperb</title>
            ...
            <div class="content">
                <div class="page-inner">
                    <div class="page-header">
                        <h4 class="page-title">View Offerings</h4>
                        ...
                        <div class="col-md-12">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-stats">
                                                    <div class="numbers">
                                                        <p class="card-category">Today's Offerings</p>
                                                        <?php
                                                        $stmt = $pdo->query("SELECT currency, SUM(amount) as total 
                                                                           FROM offerings 
                                                                           WHERE DATE(offering_date) = CURDATE() 
                                                                           GROUP BY currency");
                                    ...
                                    <div class="card card-stats card-info card-round">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-stats">
                                                    <div class="numbers">
                                                        <p class="card-category">This Week's Offerings</p>
                                                        <?php
                                                        $stmt = $pdo->query("SELECT currency, SUM(amount) as total 
                                                                           FROM offerings 
                                                                           WHERE YEARWEEK(offering_date) = YEARWEEK(CURDATE())
                                                                           GROUP BY currency");
                                                        while ($row = $stmt->fetch()) {
                                                            echo "<h4 class='card-title'>{$row['currency']} " . number_format($row['total'], 2) . "</h4>";
                                                        }
                                    ...
                                    <div class="card card-stats card-success card-round">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-stats">
                                                    <div class="numbers">
                                                        <p class="card-category">This Month's Offerings</p>
                                                        <?php
                                                        $stmt = $pdo->query("SELECT currency, SUM(amount) as total 
                                                                           FROM offerings 
                                                                           WHERE MONTH(offering_date) = MONTH(CURDATE()) 
                                                                           AND YEAR(offering_date) = YEAR(CURDATE())
                                                                           GROUP BY currency");
                                                        while ($row = $stmt->fetch()) {
                                                            echo "<h4 class='card-title'>{$row['currency']} " . number_format($row['total'], 2) . "</h4>";
                                                        }
                                    ...
                                    <div class="card card-stats card-warning card-round">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-stats">
                                                    <div class="numbers">
                                                        <p class="card-category">Offering Types</p>
                                                        <?php
                                                        $stmt = $pdo->query("SELECT COUNT(DISTINCT offering_type) as total FROM offerings");
                                                        $row = $stmt->fetch();
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Offerings Summary by Type</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $offering_types = ['general', 'special', 'thanksgiving'];
                                                ...
                                                foreach ($offering_types as $type) {
                                                    foreach ($currencies as $currency) {
                                                        ...
                                                        // Only show rows with non-zero totals
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <h4 class="card-title">Offerings List</h4>
                                        <a href="offering_management.php" class="btn btn-primary btn-round ml-auto">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="offerings-table" class="display table table-striped table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Event</th>
                                            ...
                                            <tbody>
                                                <?php
                                                $stmt = $pdo->query("SELECT o.*, e.event_name 
                                                                    FROM offerings o 
                                                ...
                                                while ($row = $stmt->fetch()) {
                                                    ...
                                                    echo "<td>
                                                            <div class='btn-group'>
                                                                <a href='offering_management.php?id={$row['id']}' 
                                                                   class='btn btn-primary btn-sm' title='Edit'>
                                                                    <i class='fa fa-edit'></i>
                                                                </a>
                                                                <button type='button' 
                                                                        class='btn btn-danger btn-sm' 
                                                                        onclick='deleteOffering({$row['id']})' 
                                                                        title='Delete'>
                ...
                buttons: [
                    {
                        ...
                        buttons: [
                            ...
                            {
                                extend: 'excel',
                                title: 'Offerings_Report_' + new Date().toISOString().slice(0,10)
                            },
                            {
                                extend: 'csv',
                                title: 'Offerings_Report_' + new Date().toISOString().slice(0,10)
